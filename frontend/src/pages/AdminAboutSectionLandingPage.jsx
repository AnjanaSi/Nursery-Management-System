...
const cards = [
  {
    ...
    description: "Edit the About section heading, subtitle, and manage all About cards.",
    path: "/admin/about-section/cards",
    icon: "✏️",
  },
  {
    title: "Add New Card",
    description: "Create a new About card with a title, description, and image.",
    path: "/admin/about-section/cards/new",
    icon: "➕",
  },
];

export default function AdminAboutSectionLandingPage() {
    ...
    <div>
      <div className="admin-mgmt-header d-flex align-items-center gap-3">
        ...
        <div>
          ...
          <small className="text-muted">Manage the public About section content and cards</small>
        </div>
      </div>
