...
export default function AdminAboutSectionCardsPage() {
  ...
  const confirmDelete = async () => {
    ...
    setDeleting(true);
    try {
      await deleteAboutCard(deleteId);
          ...
          <form onSubmit={handleConfigSave}>
            ...
            <div className="mb-3">
              ...
              <input
                ...
                maxLength={120}
                placeholder="e.g. About MerryKids"
                required
              />
            </div>
            <div className="mb-3">
      ...
      <div className="card border-0 shadow-sm rounded-4 p-4 mb-4">
        <div className="d-flex align-items-center justify-content-between mb-3">
          ...
          <button
            ...
            onClick={() => navigate("/admin/about-section/cards/new")}
          >
            + Add Card
          </button>
        </div>
        ...
        {cardsLoading ? (
          ...
          <div className="admin-empty-state py-4">
            ...
            <h5>No Cards Yet</h5>
            <p>Add your first About card using the button above.</p>
          </div>
        ) : (
                  ...
                  <tr key={card.id}>
                    ...
                    <td>
                      <div className="d-flex gap-1 flex-wrap">
                        ...
                        <button
                          className="btn btn-sm btn-outline-primary rounded-3"
                          onClick={() => navigate(`/admin/about-section/cards/${card.id}/edit`)}
                        >
                          Edit
                        </button>
                        <button
          ...
          <div className="modal-content rounded-4">
            ...
            <div className="modal-body">
              <p className="admin-confirm-text">
                Are you sure you want to delete this About card? It will be hidden from the public
