...
const cards = [
  {
    title: "Add New Event",
    description: "Create a new event with a description, date, and photos.",
    path: "/admin/events/new",
    icon: "📅",
  },
  {
    title: "Events Directory",
    description: "View, search, edit, and manage all published events.",
    path: "/admin/events/list",
    icon: "🗓️",
  },
];

export default function AdminEventsLandingPage() {
    ...
    <div>
      <div className="admin-mgmt-header d-flex align-items-center gap-3">
        ...
        <div>
          ...
          <small className="text-muted">Manage public events and photo galleries</small>
        </div>
      </div>
